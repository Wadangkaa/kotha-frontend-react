								...
								<aside className="axil-dashboard-aside">
									<nav className="axil-dashboard-nav">
										<div className="nav nav-tabs" role="tablist">
											...
											<a className="nav-item nav-link" href="sign-in.html"><i className="fal fa-sign-out"></i>Logout</a>
										</div>
									</nav>
								</aside>
							</div>
								...
								<div className="tab-content">
									...
									{/* <div className="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
										<div className="axil-dashboard-overview">
											<div className="welcome-text">Hello Annie (not <span>Annie?</span> <a href="sign-in.html">Log Out</a>)</div>
